...
#define PUSH_APP_ID "alefnode.whatsweb_whatsweb"
...
QJsonObject PushClient::buildSummaryMessage(const QString &msg) {
    ...
    QString icon = QString("/opt/click.ubuntu.com/.click/users/@all/alefnode.whatsweb/icon.png");
    ...
    QString actionUri = QStringLiteral("appid://alefnode.whatsweb/whatsweb/current-user-version");
